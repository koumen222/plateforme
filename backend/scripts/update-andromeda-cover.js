...
async function updateAndromedaCover() {
  try {
    ...
    const searchTerms = [
      'Comprendre le fonctionnement de la publicités facebook en 2026',
      'ANDROMEDA',
      'andromeda',
      'braquer andromeda',
      'facebook 2026'
    ...
    const coverImageUrl = '/assets/andromeda-cover.png';
