...
const WebhookTest = () => {
  ...
  const testWebhook = async () => {
    ...
    try {
      const response = await fetch('https://plateforme-backend-production-3c54.up.railway.app/api/ecom/agent/webhook', {
        method: 'POST',
        headers: {
  ...
  const testHealth = async () => {
    ...
    try {
      const response = await fetch('https://plateforme-backend-production-3c54.up.railway.app/api/ecom/agent/health');
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <div style={styles.url}>
          URL: https://plateforme-backend-production-3c54.up.railway.app/api/ecom/agent/webhook
        </div>
