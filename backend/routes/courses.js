...
<p>Un catalogue bien structuré = plus de conversions.</p>
...
<ul>
  ...
  <li><strong>Confirmée</strong> : client appelé et confirmé</li>
...
<p>En Afrique, le Cash on Delivery représente souvent 70-80% des ventes. Scalor vous permet de gérer ce flux avec des notes clients, rappels et confirmations automatiques.</p>`,
        summary: {
...
<p>Un client qui rachète coûte 5x moins cher à convaincre qu'un nouveau client.</p>
...
<p>Dans <strong>Paramètres → Paiements</strong>, activez le mode COD et définissez les zones où il est disponible.</p>
<h3>Connecter Mobile Money</h3>
<p>Scalor s'intègre directement avec les APIs Mobile Money des principaux opérateurs. Suivez le guide d'intégration dans les paramètres.</p>`,
        summary: {
...
<p>Une livraison rapide et bien communiquée = client satisfait qui revient.</p>
<h3>Configurer les zones de livraison</h3>
<ol>
  <li>Aller dans <strong>Paramètres → Livraison</strong></li>
  <li>Créer des zones géographiques (ex : Douala ville, Yaoundé…)</li>
  <li>Définir un tarif fixe ou calculé selon le poids</li>
  <li>Activer la livraison gratuite à partir d'un certain montant</li>
</ol>
<h3>Connecter votre livreur</h3>
<p>Créez un compte livreur dans Scalor. Il recevra les détails de commande directement sur son interface mobile.</p>
...
<p>Dans <strong>Marketing → Automatisations</strong>, activez chaque scénario et personnalisez le message avec les variables disponibles.</p>`,
        summary: {
...
<p>Ce qui ne se mesure pas ne se gère pas. Scalor vous donne accès à des analytics claires.</p>
...
<ul>
  ...
  <li><strong>Taux de livraison</strong> : commandes livrées / expédiées (objectif : >75%)</li>
...
<p>Activez le rapport hebdomadaire par email dans <strong>Paramètres → Rapports</strong>. Chaque lundi matin, vous recevrez un résumé complet.</p>`,
        summary: {
          text: 'Utilisez les données Scalor pour prendre de meilleures décisions et accélérer la croissance de votre business.',
          points: [
            'Identifier les KPIs les plus importants',
...
<p>Une fois les bases en place, Scalor vous donne les leviers pour multiplier votre chiffre d'affaires.</p>
...
<p>Récompensez vos meilleurs clients avec des points ou des remises exclusives.</p>
<h3>Levier 3 — Référence et parrainage</h3>
<p>Créez un programme de parrainage où chaque client satisfait vous ramène de nouveaux clients en échange d'une récompense.</p>
<h3>Levier 4 — Équipe et délégation</h3>
<p>Scalor vous permet d'inviter des collaborateurs (gestionnaire de commandes, SAV, livreur) avec des droits d'accès limités.</p>`,
        summary: {
          text: 'Appliquez les stratégies de scaling pour multiplier votre chiffre d\'affaires en utilisant pleinement Scalor.',
          points: [
