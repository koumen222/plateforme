...
4. **Déployer**
   ...
   - L'URL sera générée automatiquement (ex: `https://plateforme-backend-production-3c54.up.railway.app`)
...
```bash
# Test de santé
curl https://plateforme-backend-production-3c54.up.railway.app/health
