...
### ✅ CORRECT
```
VITE_API_BASE_URL=https://plateforme-backend-production-3c54.up.railway.app
```
...
2. Ajoutez la variable pour **Production** :
   ...
   Value: https://plateforme-backend-production-3c54.up.railway.app
   ```
...
3. Vous devriez voir : `🌐 MODE PRODUCTION - BACKEND_URL depuis VITE_API_BASE_URL: https://plateforme-backend-production-3c54.up.railway.app`
...
Si vous voyez toujours `https://plateforme-backend-production-3c54.up.railway.app//api/...` :
